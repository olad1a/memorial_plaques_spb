...
new_df <- new_df %>%
  separate(Other, c("Other", "Address"), sep = "Адреса")

new_df <- new_df %>%
  separate(Address, c("Address", "q"), sep = "Предметный") %>%
  select(-q) 
...
plaques[ID == "2805530337", Person := "Алексееву С. В."]
plaques[ID == "2805531128", Person := "Аничкову Н. Н."]
plaques[ID == "2805551198", Person := "Гоголю Н. В."]

#manually fixing plaque dates
plaques[ID == "2805531090", Year := "До 1978"]
plaques[ID == "2805549446", Year := "1949"]
plaques[ID == "2805531187", Year := "До 1977"]
...
plaques[ID == "2805531592", Year := "До 1977"]
plaques[ID == "2805531635", Year := "1960-е"]
plaques[ID == "2805531801", Year := "1949"]
plaques[ID == "2805550894", Year := "1988"]
plaques[ID == "2805531900", Year := "До 1977"]
plaques[ID == "2805531942", Year := "До 1976"]
plaques[ID == "2805531975", Year := "1950-е"]
...
plaques[ID == "2805551514", Year := "19-й век"]
plaques[ID == "2805551543", Year := "1991"]
plaques[ID == "2805551563", Year := "1955"]
plaques[ID == "2805524951", Year := "1910-е"]
plaques[ID == "2805524970", Year := "1990-е"]
plaques[ID == "2805544875", Year := "1980-е"]
plaques[ID == "2805544896", Year := "1960-е"]
plaques[ID == "2805544968", Year := "1960-е"]
plaques[ID == "2805545014", Year := "1983"]
plaques[ID == "2805545060", Year := "До 1978"]
plaques[ID == "2805526888", Year := "1948"]
plaques[ID == "2805526845", Year := "1940-е"]
plaques[ID == "2805526836", Year := "1940-е"]
plaques[ID == "2805527021", Year := "1983"]
plaques[ID == "2805527042", Year := "1920-е"]
plaques[ID == "2805545161", Year := "1930-е"]
plaques[ID == "2805527143", Year := "1934"]
plaques[ID == "2805552269", Year := NA]
plaques[ID == "2805527232", Year := "1985"]
plaques[ID == "2805545430", Year := "До 1977"]
plaques[ID == "2805527278", Year := "1930-е"]
plaques[ID == "2805545596", Year := "До 1977"]
plaques[ID == "2805552747", Year := "1955"]
plaques[ID == "2805545650", Year := "1978"]
plaques[ID == "2805525089", Year := "До 1941 г."]
plaques[ID == "2805527508", Year := "1940-е"]
plaques[ID == "2805527957", Year := "1960"]
plaques[ID == "2805527967", Year := "1960"]
plaques[ID == "2805528332", Year := "1967"]
plaques[ID == "2805527457", Year := "1930-е"]
plaques[ID == "2805527499", Year := "1940-е"]
plaques[ID == "2805545966", Year := "1997"]
plaques[ID == "2805525156", Year := "До 1917"]
plaques[ID == "2805546126", Year := "1960-е"]
plaques[ID == "2805546158", Year := "1960-е"]
plaques[ID == "2805525615", Year := NA]
plaques[ID == "2805546209", Year := "1914-1915"]
plaques[ID == "2805529015", Year := "1950-е"]
plaques[ID == "2805546443", Year := "1960-е"]
plaques[ID == "2805546364", Year := "1930-е"]
plaques[ID == "2805525701", Year := "1998"]
plaques[ID == "2805525759", Year := "1905"]
plaques[ID == "2805525759", Description := "Мемориальные доски с фамилиями выпускников Пажеского корпуса, погибших на поле боя с 1805 по 1905 годы"]
plaques[ID == "2805525770", Year := "1910-е"]
plaques[ID == "2805525788", Year := "1970-е"]
plaques[ID == "2805525798", Year := "1910-е"]
plaques[ID == "2805547192", Year := NA]
plaques[ID == "2805547444", Year := "До 1977"]
plaques[ID == "2805547320", Year := "1997"]
plaques[ID == "2805547282", Year := "1945"]
plaques[ID == "2805529139", Year := NA]
plaques[ID == "2805547566", Year := "До 1977"]
...
plaques[ID == "2805554639", Year := "1910-е"]
...
plaques[ID == "2805548566", Year := "1960-е"]
plaques[ID == "2805548586", Year := "1998"]
plaques[ID == "2805526162", Year := "1913-1914"]
plaques[ID == "2805559095", Year := NA]
plaques[ID == "2805559085", Year := "1890-е"]
plaques[ID == "2805548764", Year := "1960-е"]
plaques[ID == "2805548805", Year := "1960-е"]
plaques[ID == "2805559197", Year := "1929"]
plaques[ID == "2805529510", Year := "1970-е"]
plaques[ID == "2805548842", Year := "1980-е"]
plaques[ID == "2805548978", Year := "1993"]
plaques[ID == "2805548962", Year := NA]
plaques[ID == "2805549011", Year := "До 1977"]
plaques[ID == "2805549020", Year := "До 1983"]
plaques[ID == "2805549232", Year := "До 1977"]
...
# for (row in 1:nrow(new_plaques)) {
#     #new_plaques[row, 'Person'] <- sub('у\\s', '\\s', ignore.case = F)
#     #new_plaques[row, 'Person'] <- sub('вой\\s', 'ва\\s', ignore.case = F)
#     if (grepl("у", new_plaques[row, 'Person'])) {
#       print('ok')
#     }
# }
# test <- find_item("Ленин")
#test
...
plaques <- plaques %>%
  separate(Other, c("Other", "Names"), sep = "Персоны")

plaques <- plaques %>%
  separate(Other, c("Other", "Architect"), sep = "Арх.")
...
for (row in 1:nrow(new_plaques)) {
  ...
  else if (new_plaques[row, 'Material'] == "бронза" || new_plaques[row, 'Is_sculptor'] == TRUE) {
